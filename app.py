...
def imagenes(imagen):
    ...
    return send_from_directory('templates/sitio/img', imagen)

@app.route('/css/<archivocss>')
def css_link(archivocss):
    print(archivocss)
    ruta_link = os.path.join('templates/sitio/css', archivocss)
    return send_from_directory('templates/sitio/css', archivocss)
